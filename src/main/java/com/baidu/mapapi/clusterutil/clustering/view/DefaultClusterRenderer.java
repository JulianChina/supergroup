...
public class DefaultClusterRenderer<T extends ClusterItem> implements
     ...
     * <p/>
     * This must be com.run off the UI thread. Work is coordinated in the RenderTask, then queued up to
    ...
    private class RenderTask implements Runnable {
        ...
        /**
         * A callback to be com.run when all work has been completed.
         *
         * @param callback
         */
